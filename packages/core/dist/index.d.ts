...
type Models = {
    ...
    [ModelProviderName.NODEMOBILE]: Model;
...
declare const EmbeddingProvider: {
    readonly NodeMobile: "NodeMobile";
...
declare const getEmbeddingConfig: () => Promise<EmbeddingConfig>;
declare function getEmbeddingType(runtime: IAgentRuntime): "local" | "remote" | "node_mobile";
declare function getEmbeddingZeroVector(): Promise<number[]>;
/**
...
declare function getModelSettings(provider: ModelProviderName, type: ModelClass): Promise<ModelSettings$1 | undefined>;
